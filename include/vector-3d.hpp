...
namespace ltt {
    class Vector3D {
        public:
             ...
             */
            Vector3D		operator*		(double multiplier)							const noexcept(false);

            [[nodiscard]]
    		double			getX			() 											const noexcept(true);

            [[nodiscard]]
    		double			getY			() 											const noexcept(true);

            [[nodiscard]]
    		double			getZ			() 											const noexcept(true);
             ...
             */
            [[nodiscard]]
    		double			getLength		()											const noexcept(false);
